  ...
  render () {
    return (
      <View className='aboutUsBox'>
        <View className='aboutUsTitle'>湖北墨秀文化传媒有限公司,创立于湖北武汉市,是一家从事教育图书策划、编辑、出版、销售发行的文化传播公司。
          本公司自主研发,自主制造,自主营销,研发体系,制造以西,营销.</View>
        <Image className='aboutUsImage'src={ aboutUs }></Image>
        <View className='aboutUsIntro'>地址：武汉市江汉区建行建行建行附近 </View>
        <View className='aboutUsIntro'>WuHan Arier Clinic Co , Ltd WuHan Arier </View>
